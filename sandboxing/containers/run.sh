...
IMAGE_NAME="rage-room-sandbox:latest"
...
# --- Locate .env file ---
ENV_FILE="${RAGE_ROOM_ENV_FILE:-$SCRIPT_DIR/.env}"
if [ ! -f "$ENV_FILE" ]; then
...
VOL_HISTORY="rage-room-${PROJECT_NAME}-history"
VOL_CLAUDE="rage-room-${PROJECT_NAME}-claude"
VOL_CODEX="rage-room-${PROJECT_NAME}-codex"
VOL_GH="rage-room-${PROJECT_NAME}-gh"

# --- Container name ---
CONTAINER_NAME="rage-room-${PROJECT_NAME}"
